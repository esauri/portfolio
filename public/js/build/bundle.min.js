...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	  ...
	  if (document.getElementsByClassName('gallery-container').length > 0) {
	    var galleries = Array.from(document.getElementsByClassName('gallery-container'));

	    galleries.forEach(function (gallery) {
	      (0, _gallery.Gallery)(gallery);
	    });
	  }
...
/***/ function(module, exports) {
	...
	function Gallery(gallery) {
	  var slides = Array.from(gallery.getElementsByClassName('gallery-item')),
